...
export default function Post({src, text}:{src:string, text:string}) {
    return (
        ...
        <div className="grid grid-cols-5 grid-rows-6 gap-2  bg-gray-100 rounded mb-5 p-5 border border-gray-200 hover:shadow-md hover:bg-white transition-all duration-500 shadow-sm group">
            ...
            <Image alt="post image" src={src} width={500} height={500} placeholder="blur" blurDataURL="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Placeholder_view_vector.svg/681px-Placeholder_view_vector.svg.png?20220519031949" loading="lazy" className="transition-all duration-500 hover:scale-110"/>
